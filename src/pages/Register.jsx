        ...
        <div className="main flex mx-auto items-center justify-between h-screen flex-col bg-gradient-to-b from-blue-400 to-white">
            <div className='flex mx-auto items-center justify-end md:justify-center h-screen flex-col'>
                ...
                <form className='flex flex-col justify-center items-center' >
                    <input type="text" placeholder="Enter your name" className='bg-black p-5 rounded-xl m-3' />
                    <input type="email" placeholder="Enter your email" className='bg-black p-5 rounded-xl m-3' />
                    <input type="password" placeholder="Enter your password" className='border-green-500 p-5 bg-black rounded-xl m-3' />
                    ...
                    <div className='mt-4'>Have an account already ?
                        ...
                        <a href="/" className='ml-2 text-green-400'>Login </a>
                    </div>
                </form>
            </div>
